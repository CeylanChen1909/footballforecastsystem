...
public interface VideoHubService {
    ...
    VideoHubPage listPublicVideosPage(String keyword, String leagueName, String platform, String videoType, Integer page, Integer size);
    long countPublicVideos(String keyword, String leagueName, String platform, String videoType);
